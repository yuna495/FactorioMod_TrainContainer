...
function MergingChests.can_move_inventories(from_entities, to_entity_name, to_entity_count)
	...
	return from_item_count <= (split_chest_name and MergingChests.get_inventory_size(to_inventory_size, to_entity_count, split_chest_name) or to_inventory_size * to_entity_count)
end
