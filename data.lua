...
for _, orientation in ipairs({ 'wide', 'high' }) do
	data:extend({ {
		type = 'sprite',
		name = 'train-container-status-lamp-'..orientation,
		filename = graphics_path..'/train-loading/'..orientation..'-lamp.png',
		width = 288, height = 288, scale = 1 / 3,
		draw_as_glow = true
	} })
end
